...
- [Live Demo Link](https://odininventoryapp-production.up.railway.app/catalog)
...
```sh
  cd my-folder
  git clone https://github.com/andrianarivo/odin_inventory_app.git
```
...
```sh
  DEBUG=odin-inventory-app:*,app npm start
```
